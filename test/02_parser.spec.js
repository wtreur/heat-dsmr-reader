...
const parser = require('../node-dsmr/parser')
...
const dsmr5Heat = [
  ...
  '\r',
  '1-3:0.2.8(50)\r',
  '0-0:1.0.0(210428203522W)\r',
  '0-0:96.1.1(41444333313030303030303637353231)\r',
  '0-0:96.13.1()\r',
  '0-0:96.13.0()\r',
  '0-1:24.1.0(004)\r',
  '0-1:96.1.0(721158722D2C340C)\r',
  '0-1:24.2.1(210428203522W)(35.741*GJ)\r',
  '!6503'
]
...
describe('Parser tests:', function () {
  ...
  describe('parse DSMR 5.x heat telegram', function () {
    var result

    before(function (done) {
      // Parse DSMR 5.x district heat message
      result = parser(dsmr5Heat)
    ...
    it('the meter model should have been determined', function () {
      assert.strictEqual(result.meterModel, 'NWA-WARMTELINK', 'wrong meter model')
    })

    it('the power equipment Id should have been determined', function () {
      assert.strictEqual(result.power.equipmentId, 'ADC3100000067521', 'wrong equipment Id')
    })

    it('the consumed heat should have been determined', function () {
      assert.strictEqual(result.heat.totalConsumed, 35.741, 'wrong total heat consumption')
      assert.strictEqual(result.heat.reportedPeriod, 5, 'wrong reported period')
    })

    it('the consumed heat timestamp should have been determined', function () {
      assert.strictEqual(result.heat.timestamp, 1619634922, 'wrong timestamp heat measurement')
    })
